...
/**
 * Blobfolio_Sniffs_PHP_CharacterBeforePHPOpeningTagSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Blobfolio_Sniffs_PHP_CharacterBeforePHPOpeningTagSniff implements PHP_CodeSniffer_Sniff
{
	...
	public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr) {
		...
		if ($stackPtr !== $expected) {
			$error = 'An opening PHP tag should be the first content in the file';
